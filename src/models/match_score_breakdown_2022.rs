...
pub struct MatchScoreBreakdown2022 {
    ...
    pub blue: Option<Box<crate::models::MatchScoreBreakdown2022Alliance>>,
    #[serde(rename = "red", skip_serializing_if = "Option::is_none")]
    pub red: Option<Box<crate::models::MatchScoreBreakdown2022Alliance>>,
}
...
impl MatchScoreBreakdown2022 {
    ...
    pub fn new() -> MatchScoreBreakdown2022 {
